#
# Makfile - Write by Leonardo Physh (leonardo.physh@yahoo.com.hk)
# 
# Project Name : YB-IV
# 
# Code Author : Leonardo Physh (e-mail: leonardo.physh@yahoo.com.hk)
#

#Makefile模板来源 : http://blog.chinaunix.net/uid-20608849-id-360294.html
#模板作者 ： Author Red_Liu lli_njupt@163.com v0.1
...
#target name
TARGETMAIN = fiscal_os
TARGETLIBS = fiscal_os.a
TARGETSLIBS = fiscal_os.so
...
CFLAGS += -fexec-charset=GB2312 --static
